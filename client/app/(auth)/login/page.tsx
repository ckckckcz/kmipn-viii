...
import { Atom, ChevronDown, Check, ArrowRight, CreditCard } from "lucide-react";
            ...
            <div className="w-full lg:w-[480px] xl:w-[520px] flex shrink-0 flex-col pt-16 pb-10 px-8 sm:px-14 md:px-16 lg:px-12 border-r border-gray-100 relative z-10 bg-white shadow-[20px_0_40px_-20px_rgba(0,0,0,0.05)]">
                ...
                <div className="flex-1 flex flex-col justify-center max-w-[380px] w-full mx-auto mt-4">
                    ...
                    <p className="text-[14px] text-gray-500 mb-8">
                        Belum punya akun MBG? <a href="#" className="font-semibold text-[#111111] hover:text-[#2563eb] underline underline-offset-2 transition-colors">Daftar Akun</a>
                    </p>
                    ...
                    <form className="flex flex-col gap-5">
                        ...
                        <div className="flex items-center justify-between mt-1">
                            <label className="relative flex items-center cursor-pointer group">
                                ...
                                <div className="w-5 h-5 rounded-[6px] border-[1.5px] border-gray-300 peer-checked:bg-[#2563eb] peer-checked:border-[#2563eb] transition-all bg-white flex items-center justify-center group-hover:border-[#2563eb]">
                            ...
                            <a href="#" className="text-[13px] font-medium text-gray-600 hover:text-[#2563eb] transition-colors underline underline-offset-4 decoration-transparent hover:decoration-[#2563eb]">
                                Lupa sandi?
                            </a>
                        </div>

                        <Button className="w-full h-[48px] bg-[#2563eb] hover:bg-[#1d4ed8] text-white rounded-[10px] text-[15px] font-medium mt-3 transition-colors shadow-md shadow-[#2563eb]/20 hover:shadow-lg border-0 hover:shadow-[#2563eb]/30">
                            Masuk
                        </Button>
                    </form>
            ...
            <div className="hidden lg:block relative  flex-1 bg-slate-950 overflow-hidden">
                ...
                <div className="relative z-10 w-full h-full flex flex-col pt-38 px-16 xl:px-24">
                    <h2 className="text-[44px] leading-[1.1] font-bold text-white max-w-[500px]">
                        Platform Distribusi Nutrisi Terpadu
                    </h2>
                    <p className="mt-3 text-[18px] leading-[1.6] text-gray-300 max-w-[500px]">
                        Pantau dan kelola rute makanan bergizi secara transparan, mudah, dan terhubung antar daerah demi generasi masa depan.
                    </p>
                </div>
            </div>
        </div>
