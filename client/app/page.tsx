    ...
    <main className="flex flex-col w-full bg-[#fdfdfd] overflow-x-hidden font-sans tracking-tight">
      ...
      */}
      <div className="relative lg:min-h-screen lg:mt-0 mt-5 w-full flex items-center justify-center pt-20">
        ...
        <div className="absolute top-[0%] left-[-10%] w-[60%] h-[60%] rounded-full bg-[#f15c12]/20 blur-[140px] opacity-70 pointer-events-none" />
        <div className="absolute top-[20%] right-[-10%] w-[50%] h-[50%] rounded-full bg-[#f15c12]/20 blur-[140px] opacity-70 pointer-events-none" />
        <div className="absolute bottom-[-10%] left-[20%] w-[60%] h-[60%] rounded-full bg-[#f15c12]/10 blur-[140px] opacity-60 pointer-events-none" />
          ...
          <div className="relative z-10 flex flex-col items-start md:items-center text-left md:text-center px-4 md:px-8 w-full">
            ...
            <div className="mt-4 md:mt-10 grid grid-cols-2 sm:flex sm:flex-row items-center gap-3 lg:gap-6 relative w-full sm:w-auto">
              <div className="relative w-full sm:w-auto">
                <a href="/login" className="w-full sm:w-auto group relative z-10 flex h-11 items-center justify-center gap-1 md:gap-2 rounded-full bg-[#f15c12] px-1 md:px-6 text-[13px] md:text-[14px] font-medium text-white transition-all hover:bg-[#1d4ed8] shadow-md hover:shadow-lg">
                  Pelajari Fitur
