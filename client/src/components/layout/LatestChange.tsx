...
const latestChange = {
  badge: "AWAS SYSTEM",
  title: "Pembaruan Model K3",
  description: "Akurasi deteksi APD meningkat.", // TIP: Use a single line of text for the description. (max 5 words)
  readMore: { href: "#", label: "Pelajari selengkapnya" },
} as const;
