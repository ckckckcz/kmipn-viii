                ...
                <div className="flex-1 flex flex-col justify-center max-w-[380px] w-full mx-auto mt-4">
                    ...
                    <form className="flex flex-col gap-5">
                        <div className="flex flex-col gap-2">
                            <label className="text-[14px] font-semibold text-gray-800">Nama Lengkap</label>
                            <input
                                type="text"
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-[14px] font-semibold text-gray-800">Instansi / Organisasi (Opsional)</label>
                            <input
                                type="text"
                        ...
                        <Button className="w-full h-[48px] bg-[#f15c12] hover:bg-[#d44805] text-white rounded-[10px] text-[15px] font-medium mt-2 transition-colors shadow-md shadow-[#f15c12]/20 hover:shadow-lg border-0 hover:shadow-[#f15c12]/30">
                            Daftar Sekarang
                        </Button>
                    </form>
                    ...
                    <div className="relative flex items-center py-5 my-2">
                        ...
                        <span className="flex-shrink-0 mx-4 text-gray-400 text-[13px] font-medium tracking-wide">atau daftar dengan</span>
                        <div className="flex-grow border-t border-gray-200"></div>
                    </div>
